            ...
            <div
                ...
                <motion.div
                    ...
                    <section className="w-[75%] sm:w-[80%] md:w-[75%] xl:w-[83%] md:flex xl:gap-16">
                        <motion.div
                            ...
                            <h3 className="text-4xl font-bold mb-5 text-headtext xl:text-5xl">Design</h3>
                            <p className="text-xs text-smalltext xl:text-base xl:w-[86%]">I&apos;m probably not the typical designer positioned behind an Illustrator artboard adjusting pixels, but I design. Immersed in stylesheets tweaking font sizes and contemplating layouts is where you&apos;ll find me (~_^). I&apos;m committed to creating fluent user experiences while staying fashionable.</p>
                        </motion.div>
                ...
                <div className="w-full h-full bg-[#043cec] flex justify-center items-center flex-col">
                    <motion.div
                        ...
                        <div className="w-[65%] mx-auto sm:w-[80%] xl:w-1/2 h-full md:py-20 flex flex-col items-start sm:gap-5 text-xs xl:text-base text-slate-100 mt-20 gap-3 tracking-wide">
                            <h3 className="text-4xl font-bold text-[#c4f36e] xl:text-5xl">Over the <br /> years,</h3>
