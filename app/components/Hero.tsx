...
import MyImage from '@/app/assets/Images&Icons/my-image.webp'
            ...
            <motion.main ref={container}
                ...
                <div className="w-full sm:w-[50%] h-[38vh] sm:h-full bg-[#9ced5a] flex justify-center sm:justify-normal sm:items-start items-center  relative">
                    ...
                    <motion.section
                        ...
                        <figure className="absolute z-50">
                            <Image src={MyImage} alt="Subhajit's portfolio image" className="w-56 h-56" placeholder="blur" priority loading="eager" />
                        </figure>
                ...
                <motion.section
                    ...
                    <figure className="absolute z-30">
                        <Image src={MyImage} alt="Subhajit's portfolio image" className="w-56 h-56 lg:w-72 lg:h-72 xl:w-80 xl:h-80" placeholder="blur" priority loading="eager" />
                    </figure>
