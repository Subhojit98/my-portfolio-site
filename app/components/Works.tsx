            ...
            <div className="w-full h-[50vh]  mt-20 relative xl:h-[90vh]">
                ...
                <motion.div
                    ...
                    <section className="w-[80%] h-[80%] sm:w-[75%] text-xs p-5  xl:ml-14  z-50 ">
                        ...
                        >
                            <h3 className="text-3xl font-bold text-headtext mb-3 xl:text-5xl">I build & <br /> design stuff</h3>
                            <p className="w-[85%] lg:w-[60%] xl:w-[55%] my-7 text-neutral-600 text-base xl:text-xl">Open source
                                projects, web apps
                                and experimentals.</p>
                        </motion.div>
